document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!answers || !surveyData) {
        document.body.innerHTML = '<h1>Error: No se encontraron datos.</h1><p>Por favor, complete la encuesta primero.</p><a href="index.html">Volver</a>';
        return;
    }
...
// --- Master Report Generation Engine (from v3) ---
